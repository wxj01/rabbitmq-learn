 ...
 * @author wxj
 * @version 1.0.0
 * @ClassName DeadAndDelayConfig.java
 * @Description TODO
 * @createTime 2021年09月22日 20:15:00
 */
@Configuration
public class DeadAndDelayConfig {
    ...
    // 声明延时Exchange
    @Bean("delayExchange_2")
    public DirectExchange delayExchange(){
        return new DirectExchange(DELAY_EXCHANGE_NAME);
    }

    // 声明死信Exchange
    @Bean("deadLetterExchange_2")
    public DirectExchange  directExchagne(){
    ...
    public Binding delayBindingA(@Qualifier("delayQueueA") Queue queue,
                                 @Qualifier("delayExchange_2") DirectExchange exchange){
    ...
    public Binding deadLetterBindingA(@Qualifier("deadLetterQueueA") Queue queue,
                                      @Qualifier("deadLetterExchange_2") DirectExchange exchange){
